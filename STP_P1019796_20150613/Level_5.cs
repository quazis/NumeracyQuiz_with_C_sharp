...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        private void buttonStrat_Click(object sender, EventArgs e)
        {
            ...
            num1 = random.Next(35, 45);
            textBox1.Text = num1.ToString();

            num2 = random.Next(65, 90);
            textBox2.Text = num2.ToString();

            num3 = random.Next(11, 15);
            textBox3.Text = num3.ToString();

            num4 = num3*random.Next(5, 7);
            textBox4.Text = num4.ToString();

            num6 = random.Next(11, 15);
            textBox6.Text = num6.ToString();

            num5 = num6 * random.Next(4, 6);
            textBox5.Text = num5.ToString();

            num7 = random.Next(32, 50);
            textBox7.Text = num7.ToString();

            num8 = random.Next(16, 25);
            textBox8.Text = num8.ToString();

            num9 = random.Next(8, 12);
