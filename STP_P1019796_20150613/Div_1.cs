...
{
    public partial class Div_1 : Form
    {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        BasicCalculator cal01 = new BasicCalculator();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        private void buttonStrat_Click(object sender, EventArgs e)
        {
            ...
            num2 = random.Next(3, 5);
            textBox2.Text = num2.ToString();

            num1 = (num2) * (random.Next(6, 9));
            textBox1.Text = num1.ToString();

            num4 = random.Next(8, 11);
            textBox4.Text = num4.ToString();

            num3 = random.Next(2, 5);
            textBox3.Text = num3.ToString();

            num6 = random.Next(5, 8);
            textBox6.Text = num6.ToString();

            num5 = (num6) * 10;
            textBox5.Text = num5.ToString();

            num8 = random.Next(11, 15);
            textBox8.Text = num8.ToString();

            num7 = (num8) * (random.Next(3, 6));
            textBox7.Text = num7.ToString();

            num10 = random.Next(7, 10);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        private void buttonCheck_Click(object sender, EventArgs e)
        {
            if ((answer1.Text != "") && (answer2.Text != "") && (answer3.Text != "") && (answer4.Text != "") && (answer5.Text != ""))
            {
                ...
                if ((ans2 / num3 == num4) && (pictureBox_W2.Visible = true))
                {
                    pictureBox_R2.Visible = true;
                    pictureBox_W2.Hide();
                    answer2.ReadOnly = true;
                ...
                if ((ans5 / num9 == num10) && (pictureBox_W5.Visible = true))
                {
                    pictureBox_R5.Visible = true;
                    pictureBox_W5.Hide();
                    answer5.ReadOnly = true;
                ...
                ////////////////////////////////////////////////////////////////////////////////////////
                Div_Congratulation divcong = new Div_Congratulation();
