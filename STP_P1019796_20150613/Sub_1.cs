...
{
    public partial class Sub_1 : Form
    {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        Multiply_1 multy01 = new Multiply_1();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        private void buttonStrat_Click(object sender, EventArgs e)
        {
            ...
            num1 = random.Next(10, 14);
            textBox1.Text = num1.ToString();

            num2 = num1 - random.Next(4, 7);
            textBox2.Text = num2.ToString();

            num3 = random.Next(15, 20);
            textBox3.Text = num3.ToString();

            num4 = num3-10;
            textBox4.Text = num4.ToString();

            num5 = random.Next(21, 30);
            textBox5.Text = num5.ToString();

            num6 = num5 - random.Next(12, 17);
            textBox6.Text = num6.ToString();

            num7 = random.Next(31, 40);
            textBox7.Text = num7.ToString();

            num8 = num7 - 20;
            textBox8.Text = num8.ToString();

            num9 = random.Next(10, 20);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        private void buttonCheck_Click(object sender, EventArgs e)
        {
            if ((answer1.Text != "") && (answer2.Text != "") && (answer3.Text != "") && (answer4.Text != "") && (answer5.Text != ""))
            {
                ...
                ////////////////////////////////////////////////////////////////////////////////////////
                Sub_Congratulation subcong = new Sub_Congratulation();
